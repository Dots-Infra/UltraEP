 ...
 *   - uses the retained fastt feasibility oracle on the skewed-load path
        ...
        .def(
            ...
            [](const PlacementSolverQuota& self,
               ...
               int kernel_stage) {
                ...
                EP_HOST_ASSERT(rank_quota_prefix.device().is_cuda() && rank_quota_prefix.dtype() == torch::kInt32);
